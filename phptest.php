			...
			<div class="tutor-col-12 tutor-col-md-4 tutor-col-lg-3 tutor-dashboard-left-menu">
				<ul class="tutor-dashboard-permalinks">
					...
					foreach ( $dashboard_pages as $dashboard_key => $dashboard_page ) {
                        ...
                        if ( current_user_can( tutor()->instructor_role ) && in_array( $dashboard_key, array( 'create-course', 'my-courses', 'earning', 'withdraw', 'reviews' ) ) ) {
                            $instructor_menu_items[] = array(
                                'key' => $dashboard_key,
                                'html' => $menu_html
                            );
                        } else {
                    ...
                    $merged_menu_items = array_merge( $instructor_menu_items, $other_menu_items );

foreach ( $merged_menu_items as $menu_item ) {
    echo $menu_item['html'];
}
